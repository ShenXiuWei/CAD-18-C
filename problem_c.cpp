  ...
  for (int layer = 1; layer <= total_layers; layer++) {
    ...
    for (int x = 0; x < qwindow_x; x++) {
        ...
        for (int y = 0; y < qwindow_y; y++) {
            ...
            if(index==1640)
            {
                int vecsize = qwindows[index].contribute_metals.size();
                printf("QW1640\n");
                for( int i=0 ; i<vecsize ; i++){
                  int temp_id = qwindows[1640].contribute_metals[i];
                  printf(" %d \n" , temp_id );
                }
            }
            else if(index==1641){
              int vecsize = qwindows[1641].contribute_metals.size();
              printf("QW1641\n");
              for( int i=0 ; i<vecsize ; i++){
                int temp_id = qwindows[1641].contribute_metals[i];
                printf(" %d \n" , temp_id );
              }
            }
            else if(index==1674){
              int vecsize = qwindows[1674].contribute_metals.size();
              printf("QW1674\n");
              for( int i=0 ; i<vecsize ; i++){
                int temp_id = qwindows[1674].contribute_metals[i];
                printf(" %d \n" , temp_id );
              }
            }
            else if(index==1675){
              int vecsize = qwindows[1675].contribute_metals.size();
              printf("QW1675\n");
              for( int i=0 ; i<vecsize ; i++){
                int temp_id = qwindows[1675].contribute_metals[i];
                printf(" %d \n" , temp_id );
              }
            }
        }
